...
<body>
    <h1>{{__('Avviso: Scadenza Esito Definitivo Segnalazione')}}</h1>
    
    <p>{{__('Gentile')}} {{ $data['investigator_name'] }},</p>
    
    <p>{{__('Ti informiamo che il termine per fornire un esito definitivo al report #:report_id sta per scadere. Sono trascorsi :days giorni dall\'ultimo aggiornamento.', [
    ...
    <p>{{__('È fondamentale fornire un esito definitivo a questa segnalazione il prima possibile per garantire il rispetto delle tempistiche previste dalla normativa sul whistleblowing.')}}</p>
