...
<body>
    ...
    <p>{{__('Ti ricordiamo che il termine di 7 giorni per aggiornare lo stato del report #:report_id sta per scadere. Sono trascorsi :days giorni dall\'ultimo aggiornamento.', [
    ...
    <p>{{__('È necessario aggiornare lo stato di questa segnalazione entro i prossimi 2 giorni per garantire il rispetto delle tempistiche previste dalla normativa sul whistleblowing.')}}</p>
    ...
    <p>{{__('Ti invitiamo ad accedere al sistema e aggiornare lo stato della segnalazione il prima possibile.')}}</p>
